...
(function (global) {
  ...
  function applyLanguage(lang, options) {
    ...
    const direction = (global.DLO_TRANSLATION_LANGUAGE && global.DLO_TRANSLATION_LANGUAGE(lang) || {}).direction || (lang === 'ur' ? 'rtl' : 'ltr');
    ...
    document.body.classList.toggle('dlo-lang-rtl', direction === 'rtl');
